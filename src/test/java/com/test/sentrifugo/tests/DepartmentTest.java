...
public class DepartmentTest {
    ...
    public void validateDepartmentFunctionality(){
        ...
        departmentPage.validateDepartMentFunctionality("IT","767888","Department added successfully.");

        departmentPage.validateAllInforFromList("Information Technology","IT","01/05/2001","Thomas E",
